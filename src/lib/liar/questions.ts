...
export const QUESTIONS: readonly LiarQuestion[] = [
  ...
  { id: "q4", text: "일주일에 커피를 마시는 횟수는?", min: 0, max: 30 },
  { id: "q5", text: "최근 한 달 동안 영화를 본 횟수는?", min: 0, max: 30 },

  { id: "q6", text: "하루 평균 수면 시간은?", min: 0, max: 12 },
  { id: "q7", text: "일주일에 외식을 하는 횟수는?", min: 0, max: 21 },
  { id: "q8", text: "최근 일주일 동안 집에 머문 날 수는?", min: 0, max: 7 },
  { id: "q9", text: "한 달에 책을 읽는 권수는?", min: 0, max: 20 },
  { id: "q10", text: "최근 일주일 동안 대중교통을 이용한 횟수는?", min: 0, max: 50 },

  { id: "q11", text: "하루 평균 물을 마시는 컵 수는?", min: 0, max: 20 },
  { id: "q12", text: "최근 한 달 동안 배달 음식을 시킨 횟수는?", min: 0, max: 30 },
  { id: "q13", text: "일주일에 걷는 날 수는?", min: 0, max: 7 },
  { id: "q14", text: "최근 일주일 동안 커피를 안 마신 날 수는?", min: 0, max: 7 },
  { id: "q15", text: "하루 평균 앉아있는 시간(시간 단위)은?", min: 0, max: 16 },

  { id: "q16", text: "최근 한 달 동안 친구를 만난 횟수는?", min: 0, max: 30 },
  { id: "q17", text: "일주일에 집에서 요리한 횟수는?", min: 0, max: 21 },
  { id: "q18", text: "최근 일주일 동안 야식을 먹은 횟수는?", min: 0, max: 14 },
  { id: "q19", text: "한 달에 옷을 사는 횟수는?", min: 0, max: 10 },
  { id: "q20", text: "하루 평균 스트레칭하는 시간(분 단위)은?", min: 0, max: 120 },

  { id: "q21", text: "최근 한 달 동안 술을 마신 횟수는?", min: 0, max: 30 },
  { id: "q22", text: "일주일에 집을 청소하는 횟수는?", min: 0, max: 14 },
  { id: "q23", text: "최근 일주일 동안 늦잠 잔 날 수는?", min: 0, max: 7 },
  { id: "q24", text: "한 달에 택시를 이용한 횟수는?", min: 0, max: 30 },
